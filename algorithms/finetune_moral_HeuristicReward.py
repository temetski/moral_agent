...
if __name__ == "__main__":
    ...
    writer = SummaryWriter(f"runs/{run_name}/HeuristicPolicy/", filename_suffix=model_name)
    writer.add_text(
        "hyperparameters",
    ...
    for iteration in range(args.load_from+1, args.load_from + args.num_iterations + 1):
        ...
        if args.save_model and (iteration%5==0 or iteration==args.num_iterations):
            model_path = f"runs/{run_name}/HeuristicPolicy/{args.exp_name}_{iteration}.cleanrl_model"
